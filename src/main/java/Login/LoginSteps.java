...
//            enterInvalidEmail();
            driver.findElement(By.id("username")).clear();
            driver.findElement(By.id("username")).sendKeys("abattoir@gmail.com");
    ...
    static void enterValidEmail() throws InterruptedException {
        ...
        try {
            ...
            driver.findElement(By.id("username")).clear();
            driver.findElement(By.id("username")).sendKeys("vimarsha@hyperspacehub.com");
    ...
    static void enterValidPassword() throws InterruptedException {
        ...
        try {
            //Enter Valid Password
            driver.findElement(By.id("password")).clear();
            driver.findElement(By.id("password")).sendKeys("Vimarsha@123");
//            enterValidPassword();
    ...
    static void enterWrongEmailFormat() throws InterruptedException {
        try {
            ...
            driver.findElement(By.id("username")).clear();
            driver.findElement(By.id("username")).sendKeys("abattoiradmin#gmail.com");
...
//        driver.findElement(By.xpath("//button[@id=\"signinButton\"]")).click();
    ...
    public static void clickSignOut() throws InterruptedException {
...
//            driver.findElement(By.xpath("//img[@class='dropdown-toggle ng-star-inserted']")).click();
    ...
    public static void clickUserDropdown() throws InterruptedException {
